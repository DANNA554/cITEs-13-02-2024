 ...
 * @author Delvi
 */
public class FrAlumno extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrAlumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
